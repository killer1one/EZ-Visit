 ...
 */
public class SQL_ClientAsignados {

    private Sqlite myConn;
    private SQLiteDatabase db;
    private Cursor c;
    private static final String TABLE_NAME = Sqlite.TABLE_ClientAsignados;

    public SQL_ClientAsignados(Context context)
    {
    ...
    public long saveRecord(Data_ClientAsignados myData)
    {
        try{
